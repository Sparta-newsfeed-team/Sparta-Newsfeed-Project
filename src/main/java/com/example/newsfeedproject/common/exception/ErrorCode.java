...
public enum ErrorCode {
    ...
    USER_NOT_FOUND("AUTH-001", "사용자를 찾지 못했습니다.", HttpStatus.BAD_REQUEST),
    EMAIL_ALREADY_EXISTS("AUTH-002", "이미 존재하는 이메일입니다.", HttpStatus.BAD_REQUEST),

    PASSWORD_INCORRECT("USR-001", "비밀번호가 일치하지 않습니다.", HttpStatus.BAD_REQUEST),
    ...
    POST_NOT_FOUND("POST-001", "존재하지 않는 게시물입니다.", HttpStatus.BAD_REQUEST),
